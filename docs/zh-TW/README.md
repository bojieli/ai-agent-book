...
**[中文](../../README.md) · 台灣正體 ← 當前 · [English](../en/README.md) · [Tiếng Việt](../vi/README.md) · [தமிழ்](../ta/README.md) · [日本語](../ja/README.md)**

**Agent = LLM + 上下文 + 工具**——本書圍繞這個核心公式，用 10 章把 AI Agent 從原理講到工程實戰。全書正文、配圖、**88 個配套實驗**全部開源，歡迎親手把實驗跑一遍。

| 📚 **10 章** 正文，從基礎到生產 | 📂 **88 個** 配套專案（70+ 可獨立執行） | 🌐 **6 種** 語言：中 / 台灣正體 / 英 / 泰 / 越 / 日 |
| :---: | :---: | :---: |
...
中文正文原始碼位於 [`book/`](../../book/)；台灣正體/英文/泰米爾/越南語/日語版本為社群貢獻（可能滯後於中文原版），分別位於 [`book-zhtw/`](../../book-zhtw/)、[`book-en/`](../../book-en/)、[`book-ta/`](../../book-ta/)、[`book-vi/`](../../book-vi/)、[`book-ja/`](../../book-ja/)。

可使用統一的建置腳本產生中文、台灣正體、英文、泰米爾語、越南語和日語 EPUB 3 電子書。請參閱 [EPUB 建置說明](../../EPUB.md)。
...
| 🌐 **新語言翻譯** | 歡迎翻譯成更多語言，可參考台灣正體（`book-zhtw/`）、英文（`book-en/`）、泰米爾語（`book-ta/`）、越南語（`book-vi/`）、日語（`book-ja/`）的組織方式 |
