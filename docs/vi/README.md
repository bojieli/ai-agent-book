...
**[中文](../../README.md) · [台灣正體](../zh-TW/README.md) · [English](../en/README.md) · Tiếng Việt ← hiện tại · [தமிழ்](../ta/README.md) · [日本語](../ja/README.md)**
...
| 📚 **10 chương** nội dung, từ nền tảng đến sản xuất | 📂 **88** dự án đi kèm (70+ chạy độc lập) | 🌐 **6 ngôn ngữ**: Trung / 台灣正體 / Anh / Tamil / Việt / Nhật |
| :---: | :---: | :---: |
...
Mã nguồn tiếng Trung nằm trong [`book/`](../../book/); các bản Trung phồn thể (Đài Loan)/Anh/Tamil/Việt/Nhật là đóng góp cộng đồng (có thể chậm hơn bản gốc), nằm trong [`book-zhtw/`](../../book-zhtw/), [`book-en/`](../../book-en/), [`book-ta/`](../../book-ta/), [`book-vi/`](../../book-vi/), [`book-ja/`](../../book-ja/).

Trình dựng chung tạo sách EPUB 3 cho tiếng Trung giản thể, tiếng Trung phồn thể (Đài Loan), tiếng Anh, tiếng Tamil, tiếng Việt và tiếng Nhật. Xem [hướng dẫn dựng EPUB](../../EPUB.md).
