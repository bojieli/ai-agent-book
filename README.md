...
| 章 | 主题 | 一句话核心 | 项目 |
| :--: | --- | --- | :--: |
| 1 | 🚀 [Agent 基础知识](chapter1/) | 「模型即 Agent」新范式 + **Agent = LLM + 上下文 + 工具**；Harness 工程才是竞争力 | [4 →](chapter1/README.md) |
| 2 | 🎯 [上下文工程](chapter2/) | 上下文决定能力上限：KV Cache、提示工程、Agent Skills、上下文压缩 | [9 →](chapter2/README.md) |
| 3 | 📚 [用户记忆和知识库](chapter3/) | 跨会话记住用户、接入外部知识：用户记忆、RAG、结构化索引、知识图谱 | [13 →](chapter3/README.md) |
| 4 | 🛠️ [工具](chapter4/) | 工具是 Agent 的双手：MCP 协议、感知/执行/协作三类工具、事件驱动异步 Agent | [6 →](chapter4/README.md) |
| 5 | 💻 [Coding Agent 与代码生成](chapter5/) | 代码是「能创造新工具的工具」，生产级 Coding Agent 全景 | [12 →](chapter5/README.md) |
| 6 | 🎯 [Agent 的评估](chapter6/) | 把表现变成可比较信号：评估环境、指标、统计显著性、评估驱动选型 | [10 →](chapter6/README.md) |
| 7 | 🧠 [模型后训练](chapter7/) | 预训练/SFT/RL 三阶段：何时选 SFT、何时选 RL，工具调用内化、样本效率 | [14 →](chapter7/README.md) |
| 8 | 🔄 [Agent 的自我进化](chapter8/) | 不改权重也能成长：经验学习、主动工具发现、从使用者到创造者 | [7 →](chapter8/README.md) |
| 9 | 🎙️ [多模态与实时交互](chapter9/) | 从文本扩展到语音、GUI、物理世界：语音三范式、Computer Use、机器人 | [7 →](chapter9/README.md) |
