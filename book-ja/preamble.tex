...
% 本文の日本語フォント：ローカル macOS は Hiragino Mincho ProN / Hiragino Sans、
% CI（Apple フォントなし）は Noto Serif CJK JP / Noto Sans CJK JP。
\IfFontExistsTF{Hiragino Mincho ProN}{%
  ...
  \setCJKmonofont[AutoFakeBold=2.5]{Noto Serif CJK JP}%
}
