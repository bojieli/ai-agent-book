...
| --- | :--: | --- |
| [use-computer-while-calling](use-computer-while-calling/) | 📖 | Triển khai kiến trúc cộng tác hai Agent gồm Agent gọi điện thoại và Agent sử dụng máy tính. Hai Agent giao tiếp trực tiếp qua WebSocket, không cần coordinator. Agent điện thoại xử lý tương tác giọng nói, Agent máy tính thực thi tự động hóa trình duyệt; hai bên làm việc song song để hoàn thành nhiệm vụ phức tạp cần cả giọng nói và thao tác web. |
