...
| `generative_agents/` | 📖 | Stanford's "AI town" generative agents (companion to Experiment 10-7); external repository `joonspk-research/generative_agents`, which you need to clone yourself (see the main README appendix). |
## Project Types
