...
<a id="ref-^ch4-async-1"></a>[1] 用约两百行编排把现成思考模型变成持续思考 Agent、以及“训练信号决定持续思考是否有用”这一结论，见 Li, Bojie and Noah Shi. *Never Stop Thinking: Continuous-Time Language Agents.* 2026（待发表）.
