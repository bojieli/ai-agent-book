...
The two principles above—distilling implicit state and manipulating attention—explain why the status bar works well, but there is a deeper layer that the author values more: the status bar is effective fundamentally because it **feeds the model information it couldn't have figured out on its own**<sup>[[5]](#ref-^ch2-5)</sup>.
...
<a id="ref-^ch2-2"></a>[1] Li, Bojie. *Models Take Notes at Prefill: KV Cache Can Be Editable and Composable.* arXiv:2606.17107, 2026.

<a id="ref-^ch2-3"></a>[2] Anthropic, "Equipping Agents for the Real World with Agent Skills", 2025.

<a id="ref-^ch2-4"></a>[3] Anthropic, "PPTX Skill", 2025. https://github.com/anthropics/skills/

<a id="ref-^ch2-7"></a>[4] Li, Bojie and Noah Shi. *Distill, Don't Retrieve: Inference-Time Context Distillation for LLM Agent Reasoning.* 2026. https://01.me/research/context-distillation

<a id="ref-^ch2-5"></a>[5] Li, Bojie and Noah Shi. *Interaction Scaling: Grounding the Third Axis of Test-Time Compute.* arXiv:2607.11598, 2026.

<a id="ref-^ch2-8"></a>[6] Li, Bojie and Noah Shi. *Agents That Sense Physical Time: Urgency, Persistence, and Vigilance as Missing Controls for LLM Agents.* 2026. https://01.me/research/physical-time-agent

<a id="ref-^ch2-6"></a>[7] Benoit Dherin et al., "Learning without training", 2025.
